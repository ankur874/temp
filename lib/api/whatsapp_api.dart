...
class WhatsAppApi {
  ...
  Future registerNumber({pin}) async {
    var url = 'https://graph.facebook.com/v15.0/$_fromNumberId/register';
  ...
  Future deregisterNumber({pin}) async {
    var url = 'https://graph.facebook.com/v15.0/$_fromNumberId/deregister';
  ...
  Future getWhatsAppBusinessAccounts({inputToken}) async {
    var url =
        'https://graph.facebook.com/v15.0/debug_token?input_token=$inputToken';
  ...
  Future getWhatsAppBusinessAccountsList({accountId}) async {
    ...
    var url =
        'https://graph.facebook.com/v15.0/$parseAccountId/client_whatsapp_business_accounts';
  ...
  uploadMedia({required mediaFile, mediaType, mediaName}) async {
    var uri =
        Uri.parse('https://graph.facebook.com/v15.0/$_fromNumberId/media');
  ...
  Future getMediaUrl({mediaId}) async {
    var url = 'https://graph.facebook.com/v15.0/$mediaId';
  ...
  Future updateProfile(
    ...
    var url =
        'https://graph.facebook.com/v15.0/$_fromNumberId/whatsapp_business_profile';
